...
CONFIG.GPIO_BOARD_INTERFACE {sws_4bits} \
  ...
  connect_bd_intf_net -intf_net buttons_GPIO [get_bd_intf_ports switches] [get_bd_intf_pins buttons/GPIO]
  ...
  connect_bd_intf_net -intf_net switches_GPIO [get_bd_intf_ports buttons] [get_bd_intf_pins switches/GPIO]
...
preplace port buttons -pg 1 -y 200 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 60 -defaultsOSRD
preplace inst switches -pg 1 -lvl 3 -y 210 -defaultsOSRD
preplace inst buttons -pg 1 -lvl 3 -y 330 -defaultsOSRD
...
levelinfo -pg 1 0 210 550 820 960 -top 0 -bot 400
",
}
